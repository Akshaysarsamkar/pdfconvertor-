        ...
        <div className="flex h-screen items-center justify-center">
          <div className="border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <label
                htmlFor="fileInput"
                className="w-full flex items-center justify-center px-4 py-6 bg-gray-100 text-gray-700 rounded-lg shadow-lg cursor-pointerborder-blue-300 hover:bg-blue-700 duration-300 hover:text-white"
              >
              ...
              <button
                ...
                className="text-white disabled:bg-gray-400 disabled:pointer-none bg-blue-500 hover:bg-blue-700 duration-300 font-bold px-4 py-2 rounded-lg"
              >
                Convert File
              </button>
